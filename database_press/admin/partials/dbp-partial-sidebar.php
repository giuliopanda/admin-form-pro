...
<div id="sidebar-tabs" data-section="<?php echo esc_attr(sanitize_text_field(@$_REQUEST['page'])); ?>">
    <div class="js-sidebar-block js-dbpblock-dbpaction" data-open="database_press">
        <h3 class="js-sidebar-title dbp-sidebar-title" data-dbpname="dbpaction"><?php _e('Database table actions', 'db_press'); ?></h3>
    ...
    <div class="js-sidebar-block js-dbpblock-dbptables"  data-open="no_database_press">
        <h3 class="js-sidebar-title dbp-sidebar-title" data-dbpname="dbptables"><?php _e('DB TABLES', 'db_press'); ?></h3>
        <div class="js-sidebar-content dbp-sidebar-content" >
            <div><a class="dbp-sidebar-link" href="<?php echo admin_url("admin.php?page=database_press&section=information-schema"); ?>"><span class="dashicons dashicons-editor-ul"></span> <?php _e('Show all tables', 'db_press'); ?></a></div>
    ...
    <div id="dbp_documentation_box" class="js-sidebar-block"  data-open="no_database_press2" data-homepage="<?php echo esc_attr($_REQUEST['page'].((isset($_REQUEST['section'])) ? '-'.$_REQUEST['section'] : ''));?>">
